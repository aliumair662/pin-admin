        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'area  ',
                'value' => set_value( 'area  ', show_data( @$popularitem->area ), false ),
                'class' => 'form-control form-control-sm',
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'configuration',
                'value' => set_value( 'configuration', show_data( @$popularitem->configuration ), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'posted_by_id',
                  $options,
                  set_value( 'posted_by_id', show_data( @$popularitem->posted_by_id), false ),
            ...
            <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown(
                    'property_by_id',
                    $options,
                    set_value( 'property_by_id', show_data( @$popularitem->property_by_id), false ),
         ...
         <div class="form-group">
              ...
              <div class="form-check">
                ...
                <label>
                  ...
                  <?php echo form_checkbox( array(
                    ...
                    'id' => 'status',
                    'value' => 'accept',
                    'checked' => set_checkbox('status', 1, ( @$popularitem->status == 1 )? true: false ),
          ...
          <div class="col-md-6">
            <div class="form-group mt-3">
              <label> <span style="font-size: 17px; color: red;"></span>
                <?php echo get_msg('prd_dynamic_link_label') ." : ".$popularitem->dynamic_link; ?>
              </label>
            </div>
          </div>
            ...
            <div class="form-group">
              <div class="form-check">
                ...
                <?php echo form_checkbox( array(
                  ...
                  'id' => 'is_negotiable',
                  'value' => 'accept',
                  'checked' => set_checkbox('is_negotiable', 1, ( @$popularitem->is_negotiable == 1 )? true: false ),
                  'class' => 'form-check-input',
                  'onclick' => 'return false'
                )); ?>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'price_note',
                'value' => set_value( 'price_note', show_data( @$popularitem->price_note), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  ...
                  $options,
                  set_value( 'item_location_city_id', show_data( @$popularitem->item_location_city_id), false ),
          ...
          <div class="form-group">
              ...
              <?php
                if(isset($popularitem)) {
                  ...
                  $conds['city_id'] = $popularitem->item_location_city_id;
            ...
            <?php if (  @$popularitem->lat !='0' && @$popularitem->lng !='0' ):?>
              <div id="popularitem_map" style="width: 100%; height: 200px;"></div>
