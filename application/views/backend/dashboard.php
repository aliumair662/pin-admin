      ...
      <div class="row"> 
        <div class="col-lg-3 col-6">
          <!-- small box -->
            <?php 
              $data = array(
                'url' => site_url() . "/admin/property_by" ,
                'total_count' => $this->Property_type->count_all(),
                'label' => get_msg( 'total_property_count_label'),
                'icon' => "fa fa-th-list",
                'color' => "bg-primary"
              );
        ...
        <div class="col-lg-3 col-6">
            ...
            <?php 
              $data = array(
                'url' => site_url() . "/admin/posted_by" ,
                'total_count' => $this->Postedby->count_all_by(),
                'label' => get_msg( 'total_postedby_count_label'),
                'icon' => "fa fa-list",
                'color' => "bg-success"
              );
