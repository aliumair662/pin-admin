            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  ...
                  'class="form-control form-control-sm mr-3" '.$disabled.' id="posted_by_id"'
                );
              ?>
            </div>
          </div>
            ...
            <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown(
                    ...
                    'class="form-control form-control-sm mr-3" '.$disabled.' id="property_by_id"'
                  );
                ?>
            </div>
          </div> 
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  ...
                  'class="form-control form-control-sm mr-3" '.$disabled.' id="item_location_city_id"'
                );
              ?>
          </div>
...
<?php if($logged_in_user->user_id != $item->added_user_id) :?>
<script>
