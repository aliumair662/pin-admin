        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'area  ',
                'value' => set_value( 'area  ', show_data( @$reject->area ), false ),
                'class' => 'form-control form-control-sm',
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'configuration',
                'value' => set_value( 'configuration', show_data( @$reject->configuration ), false ),
                'class' => 'form-control form-control-sm',
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'floor_no',
                'value' => set_value( 'floor_no', show_data( @$reject->floor_no ), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  'posted_by_id',
                  $options,
                  set_value( 'posted_by_id', show_data( @$reject->posted_by_id), false ),
            ...
            <div class="form-group">
                ...
                <?php
                  ...
                  echo form_dropdown(
                    'property_by_id',
                    $options,
                    set_value( 'property_by_id', show_data( @$reject->property_by_id), false ),
         ...
         <div class="form-group">
              ...
              <div class="form-check">
                ...
                <label>
                  ...
                  <?php echo form_checkbox( array(
                    ...
                    'id' => 'status',
                    'value' => 'accept',
                    'checked' => set_checkbox('status', 1, ( @$reject->status == 1 )? true: false ),
          ...
          <div class="col-md-6">
            <div class="form-group mt-3">
              <label> <span style="font-size: 17px; color: red;"></span>
                <?php echo get_msg('prd_dynamic_link_label') ." : ".$reject->dynamic_link; ?>
              </label>
            </div>
            <div class="form-group">
              <label>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'price_unit',
                'value' => set_value( 'price_unit', show_data( @$reject->price_unit), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              <div class="form-check">
                ...
                <?php echo form_checkbox( array(
                  ...
                  'id' => 'is_negotiable',
                  'value' => 'accept',
                  'checked' => set_checkbox('is_negotiable', 1, ( @$reject->is_negotiable == 1 )? true: false ),
                  'class' => 'form-check-input',
                  'onclick' => 'return false'
                )); ?>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <?php echo form_input( array(
                'name' => 'price_note',
                'value' => set_value( 'price_note', show_data( @$reject->price_note), false ),
                'class' => 'form-control form-control-sm',
            ...
            <div class="form-group">
              ...
              <?php
                ...
                echo form_dropdown(
                  ...
                  $options,
                  set_value( 'item_location_city_id', show_data( @$reject->item_location_city_id), false ),
          ...
          <div class="form-group">
              ...
              <?php
                if(isset($reject)) {
                  ...
                  $conds['city_id'] = $reject->item_location_city_id;
            ...
            <?php if (  @$reject->lat !='0' && @$reject->lng !='0' ):?>
              <div id="reject_map" style="width: 100%; height: 200px;"></div>
