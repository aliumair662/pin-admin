...
<?php
	$attributes = array( 'id' => 'amenity-form', 'enctype' => 'multipart/form-data');
	...
	<div class="col-md-6">
		<div class="card card-info">
		    <div class="card-header">
		        <h3 class="card-title"><?php echo get_msg('amenities_info_label')?></h3>
		    </div>
	        <!-- /.card-header -->
	        <div class="card-body">
	            <div class="row">
	            	<div class="col-md-12">
	            		<div class="form-group">
							...
							<?php echo form_input( array(
								'name' => 'name',
								'value' => set_value( 'name', show_data( @$amenity->name ), false ),
								'class' => 'form-control form-control-sm',
								'placeholder' => get_msg( 'amenity_name' ),
								'id' => 'name'
							)); ?>
	              		</div>
	              		...
	              		<!-- <div class="col-md-6"  style="padding-left: 50px;"> -->
							...
							<div class="form-group">
								<span style="font-size: 17px; color: red;">*</span>
								<label><?php echo get_msg('amenity_img')?>
							...
							<?php
								$conds = array( 'img_type' => 'amenity', 'img_parent_id' => $amenity->id );
